...
export default class Enemy 
{
    ...
    #loadImages(){
        ...
        renemyimg1.src = "Assets 3/er1.png";
    
        const renemyimg2 = new Image();
        renemyimg2.src = "Assets 3/er2.png";
    
        const renemyimg3 = new Image();
        renemyimg3.src = "Assets 3/er3.png";
        ...
        lenemyimg1.src = "Assets 3/el1.png";
    
        const lenemyimg2 = new Image();
        lenemyimg2.src = "Assets 3/el2.png";
    
        const lenemyimg3 = new Image();
        lenemyimg3.src = "Assets 3/el3.png";
        ...
        uenemyimg1.src = "Assets 3/eu1.png";
    
        const uenemyimg2 = new Image();
        uenemyimg2.src = "Assets 3/eu2.png";
    
        const uenemyimg3 = new Image();
        uenemyimg3.src = "Assets 3/eu3.png";
        ...
        denemyimg1.src = "Assets 3/ed1.png";
    
        const denemyimg2 = new Image();
        denemyimg2.src = "Assets 3/ed2.png";
    
        const denemyimg3 = new Image();
        denemyimg3.src = "Assets 3/ed3.png";
