...
let gameOver = false;
let gameWin = false;
const gameOverSound = new Audio("sounds3/gameover.mp3");
const gameWinSound = new Audio("sounds3/gamewin.mp3");
...
{
    if(gameOver)   //if(gameOver || gameWin)
    {
        let text = "";
        if(gameOver)
        {
